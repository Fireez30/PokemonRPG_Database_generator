...
if __name__ == "__main__":
    ...
    pdf_gen_7 = "input_pdf/pokedex1-7_final_version.pdf"
    range_gen_galar = range(2,121)
    pdf_galar = "input_pdf/GalarDex + Armor_Crown.pdf"
    ...
    pdf_insurgence = "input_pdf/InsurgenceDex 1.05.pdf"
    range_hisui = range(3,31)
    pdf_hisui = "input_pdf/HisuiDex.pdf"
    range_eevolution = range(0,10)
    pdf_eevolution = "input_pdf/Eveeloutions.pdf"
    range_megaevolution = range(8,115)
    pdf_mega_evo = "input_pdf/Pokemon MegaDex.pdf"
